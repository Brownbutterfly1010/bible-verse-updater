...
<style>
  * {margin:0; padding:0; box-sizing:border-box; font-family:'Poppins',sans-serif;}
  ...
  .logo {font-size:1.5rem; font-weight:700; color:#ffca28; cursor:pointer;}
  ...
  .product-card img {width:100%; height:200px; object-fit:cover; background:#f9f9f9;}
  ...
  .modal-images img {width:80px; height:80px; object-fit:cover; cursor:pointer; border:2px solid transparent; border-radius:8px;}
  .modal-images img.selected {border-color:#007bff;}
  .main-image {width:100%; height:300px; object-fit:cover; margin-bottom:15px;}
...
<header>
  <div style="display:flex; align-items:center;">
    <div class="logo">Andros Tech Solutions</div>
  </div>
...
let productsDataList = [
  {name:'iPhone 7 Plus', basePrice:3750, battery:'90%', colors:['Black','Silver'], storages:[{size:'128GB',price:3750}], images:['https://via.placeholder.com/200x200?text=iPhone+7+Plus']},
  {name:'iPhone 8 Plus', basePrice:3850, battery:'91%', colors:['Black','Silver','Gold'], storages:[{size:'64GB',price:3850}], images:['https://via.placeholder.com/200x200?text=iPhone+8+Plus']},
  {name:'iPhone XR', basePrice:4150, battery:'92%', colors:['Red','Blue','Black'], storages:[{size:'64GB',price:4150},{size:'128GB',price:4500}], images:['https://via.placeholder.com/200x200?text=iPhone+XR']},
  {name:'iPhone 11', basePrice:6500, battery:'94%', colors:['Purple','Yellow','Black'], storages:[{size:'64GB',price:6500}], images:['https://via.placeholder.com/200x200?text=iPhone+11']},
  {name:'iPhone 12', basePrice:7500, battery:'90%', colors:['Blue','Black'], storages:[{size:'64GB',price:7500}], images:['https://via.placeholder.com/200x200?text=iPhone+12']},
  {name:'iPhone 13 Pro', basePrice:11800, battery:'92%', colors:['Silver','Graphite'], storages:[{size:'128GB',price:11800}], images:['https://via.placeholder.com/200x200?text=iPhone+13+Pro']},
  {name:'iPhone 14', basePrice:12800, battery:'95%', colors:['Blue','Midnight','Starlight'], storages:[{size:'128GB',price:12800}], images:['https://via.placeholder.com/200x200?text=iPhone+14']},
  {name:'iPhone 15', basePrice:15850, battery:'96%', colors:['Black','Silver'], storages:[{size:'128GB',price:15850}], images:['https://via.placeholder.com/200x200?text=iPhone+15']}
];
...
function fakeCheckout(){if(cart.length===0){alert('Cart is empty!'); return;} alert('✅ Thank you for your purchase! (Demo)'); cart=[]; updateCart(); toggleCart();}
renderProducts();
</script>
</body>
</html> 
